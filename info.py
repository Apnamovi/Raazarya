...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6053692745').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001979888381 -1001946764456 -1001867538832').split()]
...
MULTI_CLIENT = False
name = str(environ.get('name', 'Raazarya'))
